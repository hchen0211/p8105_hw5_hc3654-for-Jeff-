...
The probability starts at a very low level, such as 0.0024 when the group size is $n=2$. It then grows quickly, crossing 50% when the group size reaches $n=23$, meaning the chance of a shared birthday has already reached half. By the time the group size reaches $n=50$, the probability of a shared birthday is approximately 97.0%, indicating it is almost certain that two people will share a birthday. This demonstrates that a relatively small group is able to achieve an extremely high probability of having overlapping birthdays.
