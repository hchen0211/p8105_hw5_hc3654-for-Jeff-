...
```
    ...
    ## file:////private/var/folders/2g/_02lpj050qgd8z_h4zzdwwpw0000gn/T/RtmpBIvVlJ/file14c1d2cebd202/widget14c1d2e289858.html screenshot completed

![](p8105_hw5_hc3654.Rmd_files/figure-gfm/unnamed-chunk-2-1.png)<!-- -->

The probability starts at a very low level, such as 0.0024 when the
group size is $n=2$. It then grows quickly, crossing 50% when the group
size reaches $n=23$, meaning the chance of a shared birthday has already
reached half. By the time the group size reaches $n=50$, the probability
of a shared birthday is approximately 97.0%, indicating it is almost
certain that two people will share a birthday. This demonstrates that a
relatively small group is able to achieve an extremely high probability
...
```
    ...
    ## file:////private/var/folders/2g/_02lpj050qgd8z_h4zzdwwpw0000gn/T/RtmpBIvVlJ/file14c1d69c8f0da/widget14c1d73cae78.html screenshot completed
...
```
    ...
    ## file:////private/var/folders/2g/_02lpj050qgd8z_h4zzdwwpw0000gn/T/RtmpBIvVlJ/file14c1d565b6d3a/widget14c1dc602721.html screenshot completed
...
```
    ...
    ## file:////private/var/folders/2g/_02lpj050qgd8z_h4zzdwwpw0000gn/T/RtmpBIvVlJ/file14c1d2182511d/widget14c1d729b581a.html screenshot completed
